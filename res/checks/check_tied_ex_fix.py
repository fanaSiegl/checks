...
def ExecCheckTieds(entities, params):
...
############# fifth level ###### check the PART TIED name  ############################################
	...
	to_report.append(t4)	
	to_report.append(t5)					
	to_report.append(t100)				
	return to_report

# ==============================================================================

def FixCheckTieds(issues):
...
checkOptions = { 'name': 'Check TIEDs for NISSAN (PAM)', 
        'exec_action': ('ExecCheckTieds', os.path.realpath(__file__)), 
        'fix_action':  ('FixCheckTieds',  os.path.realpath(__file__)), 
